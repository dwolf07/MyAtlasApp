...
public class MyAuthenticationListener implements LayerAuthenticationListener {
    ...
    private ConversationsActivity main_activity;

    public MyAuthenticationListener(ConversationsActivity ma){
        main_activity = ma;
    }
    ...
    public void onAuthenticationChallenge(final LayerClient client, final String nonce) {
        final String mUserId = ConversationsActivity.getUserID();
